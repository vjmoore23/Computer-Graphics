...
public class FourLights extends JPanel implements GLEventListener {
    ...
    private void lights(GL2 gl) {
        ...
        if (redLight.isSelected()) {
            ...
            gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_EMISSION, zero, 5);  
            gl.glDisable(GL2.GL_LIGHT1);
        }
        gl.glPushMatrix();
        gl.glRotated(-frameNumber, 0, 2, 0);
        gl.glTranslated(10, -7, -3);
    ...
    public void display(GLAutoDrawable drawable) {    
        ...
        gl.glColor3d(1,1,1);  // sets diffuse and ambient color for teapot
